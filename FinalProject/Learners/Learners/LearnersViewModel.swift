...
class LearnersViewModel {
    var learners: [Learner] = [
        Learner(firstName: "Kwame", lastName: "Mensah", favoriteColor: .indigo),
        Learner(firstName: "Elif", lastName: "Yılmaz", favoriteColor: .pink),
        Learner(firstName: "Andrei", lastName: "Popescu", favoriteColor: .blue),
        Learner(firstName: "Ayesha", lastName: "Khan", favoriteColor: .green),
        Learner(firstName: "Wei", lastName: "Zhang", favoriteColor: .cyan),
        Learner(firstName: "Youssef", lastName: "El Amrani", favoriteColor: .gray),
        Learner(firstName: "Giulia", lastName: "Esposito", favoriteColor: .purple),
        Learner(firstName: "Wanjiru", lastName: "Kamau", favoriteColor: .green),
        Learner(firstName: "Rustam", lastName: "Karimov", favoriteColor: .indigo),
        Learner(firstName: "Layla", lastName: "Haddad", favoriteColor: .pink),
        ...
        Learner(firstName: "Putri", lastName: "Wijaya", favoriteColor: .yellow),
